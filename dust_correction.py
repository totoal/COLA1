...
def SFR_XION_dust_corrected(Hgflux, Hgflux_err, Hbflux, Hbflux_err,
    ...
    # 3.76 is k_Hb for Cardelli 1998 law
    ...
    # print('EBV', np.nanmedian(thisEBV), -np.nanmedian(thisEBV) + np.nanpercentile(thisEBV, [16, 84]))
...
if __name__ == '__main__':
    SFR_XION_dust_corrected(2.117970076761039, 0.20597032970802598,
