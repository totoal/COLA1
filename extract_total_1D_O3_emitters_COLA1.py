...
for q in range(len(IDlist)):
    ...
    for module in ['A', 'B']:
        ...
        if thisNclumps_Y == 4.:  # honestly this is only used for one object, id 19021
            ...
            params = model.make_params(m1_totflux=2, m1_c=0, m1_x0=26, m1_sigma=2, m2_totflux=0.2, m2_c=0, m2_x0=10,
                                       m2_sigma=2, m3_totflux=0.2, m3_c=0, m3_x0=30, m3_sigma=2, m4_totflux=0.2, m4_c=0, m4_x0=18, m4_sigma=2)
        ...
        pyfits.writeto(SAVE_FOLDER+'opt_weight_%s_%s_mod%s.fits' %
