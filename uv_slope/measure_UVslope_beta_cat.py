...
def fit_UV_slope(cat):
    ...
    for iii in range(N_sources):
        thisfnu_F115W = data['F115W_AUTO_fnu'][iii]
        thisfnu_F150W = data['F150W_AUTO_fnu'][iii]
        thisfnu_F200W = data['F200W_AUTO_fnu'][iii]
...
if __name__ == '__main__':
    ...
    col0 = fits.Column(name='NUMBER', format='D', array=cat[1].data['NUMBER_1'])
